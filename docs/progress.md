...
| 7 Defect lab | Local scenarios and review integration implemented | Nine-case matrix plus three-layer propagated discrepancy and reset; multi-layer UI/cause proof and broader evaluation remain |
