...
| 7B Routing | Local approval and delivery rehearsal implemented | Durable simulated issue/notification stages and receipt recovery; destination/content review implemented; real adapters, recipient configuration, provider recovery and hosted integration remain |
