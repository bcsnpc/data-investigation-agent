...
| 7 Defect lab | Local scenarios and review integration implemented | Nine-case local evaluation matrix with exact impact and reset checks; multi-layer scenarios and broader evaluation remain |
